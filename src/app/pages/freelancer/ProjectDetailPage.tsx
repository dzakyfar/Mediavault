...
export default function FreelancerProjectDetail() {
  ...
  return (
    <DashboardLayout userType="freelancer" userName="Fauzan A.">
      <div className="mb-6">
        <Link to="/dashboard/freelancer/projects" className="flex items-center gap-2 text-[#888888] hover:text-[#F5C800] transition-colors mb-4">
        ...
        <div className="grid md:grid-cols-2 gap-8">
          <div>
            ...
            <div className="space-y-2 text-sm">
              ...
              <div className="flex items-center gap-2 text-[#888888]">
                <span>💰</span>
                <span>Payment: Rp 1.500.000</span>
              </div>
            </div>
          </div>

          <div className="flex flex-col items-center text-center">
            <div className="w-20 h-20 rounded-full bg-[#1A1A1A] flex items-center justify-center mb-4 text-[#F5C800] text-2xl font-bold">
              R
            </div>
            <h3 className="text-xl font-bold mb-1">Rania K.</h3>
            <p className="text-[#888888] mb-4">Client</p>
            <Link
      ...
      <div className="flex gap-2 mb-6 border-b border-[#2A2A2A]">
        {['overview', 'files', 'timeline'].map((tab) => (
          <button
            key={tab}
      ...
      {activeTab === 'files' && (
        <div className="bg-[#1A1A1A] rounded-xl p-6">
          <div className="flex items-center justify-between mb-6">
            <h3 className="text-xl font-bold">Your Uploaded Files</h3>
            <button className="flex items-center gap-2 px-6 py-3 bg-[#F5C800] text-black font-bold rounded-lg hover:shadow-[0_0_10px_rgba(245,200,0,0.4)] transition-all">
          ...
          <div className="grid grid-cols-3 gap-4">
            {[1, 2, 3].map((i) => (
              <div key={i} className="bg-[#141414] rounded-lg p-4 border border-[#2A2A2A]">
      ...
      {activeTab === 'timeline' && (
        <div className="bg-[#1A1A1A] rounded-xl p-6">
          ...
          <div className="space-y-4">
            {[
              { event: 'You uploaded 3 files', time: '2 hours ago', color: '#F5C800' },
