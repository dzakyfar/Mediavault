...
const legalCopy = {
  terms: {
    ...
    sections: [
      ...
      'Pembayaran dan earnings: fitur payment, earnings, escrow, withdrawal, dan payout masih berada dalam tahap hold/simulasi sampai dinyatakan siap. Jangan menganggap nominal pada fitur tersebut sebagai transaksi finansial final kecuali sudah ada aktivasi resmi.',
  ...
  privacy: {
    ...
    sections: [
      ...
      'Penyimpanan file media: avatar, portfolio, gambar pesan, reference file, dan file submission project dapat diunggah ke Amazon S3 atau storage yang dikonfigurasi. Database menyimpan referensi file/key agar file dapat diakses kembali sesuai hak akses.',
      ...
      'Pihak ketiga: MediaVault dapat memakai layanan seperti Google OAuth, Amazon S3, peta/geolocation, dan layanan infrastruktur lain. Data yang diproses pihak ketiga mengikuti kebutuhan teknis fitur dan konfigurasi layanan.',
      'Retensi dan penghapusan: pengguna dapat memperbarui profil dan menghapus akun melalui settings. Beberapa data dapat tetap tersimpan sementara untuk kebutuhan keamanan, audit workflow, atau konsistensi relasi database sampai proses penghapusan teknis selesai.',
