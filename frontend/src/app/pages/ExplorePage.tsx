    ...
    <div className="min-h-screen bg-[#0A0A0A] text-white mv-ambient" style={{ fontFamily: 'DM Sans, sans-serif' }}>
      ...
      <div className="max-w-7xl mx-auto px-6 py-12">
        <h1 className="text-6xl mb-8" style={{ fontFamily: 'Bebas Neue, sans-serif' }}>
          {t('Cari Freelancer', 'Find Freelancers')}
        </h1>
        ...
        <div className="grid md:grid-cols-3 gap-6 mb-12">
          {loading && (
            <div className="md:col-span-3">
              <EmptyState title={t('Memuat freelancer', 'Loading freelancers')} description={t('Menyiapkan pilihan freelancer yang tersedia.', 'Preparing available freelancer options.')} />
            </div>
          )}
